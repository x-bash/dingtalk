...
# a.send_text_msg --text "test case for send_text_msg @13427498660 " --at "+8613427498660,13427498660,13238325221"
...
# ## Hangzhou weather @13427498660 \n> 9 degrees, northwest wind 1, good air 89, relative temperature 73% \n> ![screenshot](https://img.alicdn.com/tfs/TB1NwmBEL9TBuNjy1zbXXXpepXa-2400-1218.png)\n>###### posted at 10:20 ! [weather](https://www.dingtalk.com) \n"

# a.send_markdown_msg --title "test case for send_markdown_msg" --text "${text}" --at "+8613427498660,13427498660,13238325221"
